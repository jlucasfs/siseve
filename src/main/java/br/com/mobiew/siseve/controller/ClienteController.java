...
public class ClienteController {
    ...
    public void consultar() {
        try {
            ...
            if ( this.pacienteSelecionado != null ) {
                idAux = this.pacienteSelecionado.getId();
            }
            this.pacientes = this.clienteService.findAllPacientes( idAux, null, null, null, this.dataInclusaoInicio, this.dataInclusaoFim );
        } catch ( Exception e ) {
    ...
    public List<PacienteDTO> completePaciente( String query ) {
        ...
        this.listaCliente = this.clienteService.findAllPacientes( null, null, null, null, null, null );
...
//            }
    ...
    public void setPacientes( List<PacienteDTO> pacientesParam ) {
	...
	public Long getIdConvenioFiltro() {
		return this.idConvenioFiltro;
	}

	public void setIdConvenioFiltro( Long idConvenioFiltroParam ) {
		this.idConvenioFiltro = idConvenioFiltroParam;
	}
	...
	public Date getDataInclusaoInicio() {
		return this.dataInclusaoInicio;
	}

	public void setDataInclusaoInicio( Date dataInclusaoInicioParam ) {
		this.dataInclusaoInicio = dataInclusaoInicioParam;
	}

	public Date getDataInclusaoFim() {
		return this.dataInclusaoFim;
	}

	public void setDataInclusaoFim( Date dataInclusaoFimParam ) {
		this.dataInclusaoFim = dataInclusaoFimParam;
	}
